function [vel_command, collisions] = compute_vel_vasarhelyi_no_front(self, p_swarm, r_agent, dt)
    ...
    % This version has been changed to simulate one of the robots not
    % having a functioning sensor for the walls. It will thus go through
    % walls affecting the swarm.
    %
    ...
    %nb_agent_collisions = -nb_agents; % Nb of collisions among agents
    ...
    for agent = 1:nb_agents
        ...
        %nb_agent_collisions = nb_agent_collisions + sum(dist < 10) - 1;
